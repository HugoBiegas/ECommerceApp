    ...
    public class BookService : IBookService
    {
        ...
        public static void InitializeTestBooks()
        {
            if (_books.Count == 0)
            {
                ...
                {
                    new Book { Id = 1, Title = "Le Petit Prince", AuthorId = 1, Category = BookCategory.Fiction, Price = 12.99m, PublicationDate = new DateTime(1943, 4, 6), IsAvailable = true, Stock = 10, Description = "Un conte poétique et philosophique sous l'apparence d'un conte pour enfants." },
                    new Book { Id = 2, Title = "1984", AuthorId = 2, Category = BookCategory.Fiction, Price = 15.99m, PublicationDate = new DateTime(1949, 6, 8), IsAvailable = true, Stock = 8, Description = "Un roman dystopique qui dépeint une société totalitaire." },
                    new Book { Id = 3, Title = "L'Étranger", AuthorId = 3, Category = BookCategory.Fiction, Price = 14.50m, PublicationDate = new DateTime(1942, 5, 19), IsAvailable = true, Stock = 5, Description = "L'histoire de Meursault, un homme indifférent au monde qui l'entoure." },
                    new Book { Id = 4, Title = "Une brève histoire du temps", AuthorId = 4, Category = BookCategory.Science, Price = 22.00m, PublicationDate = new DateTime(1988, 4, 1), IsAvailable = true, Stock = 12, Description = "Les mystères de l'univers expliqués par Stephen Hawking." },
                    new Book { Id = 5, Title = "Sapiens", AuthorId = 5, Category = BookCategory.History, Price = 24.90m, PublicationDate = new DateTime(2011, 9, 4), IsAvailable = true, Stock = 15, Description = "Une brève histoire de l'humanité." },
                    new Book { Id = 6, Title = "Clean Code", AuthorId = 6, Category = BookCategory.Technology, Price = 45.00m, PublicationDate = new DateTime(2008, 8, 1), IsAvailable = true, Stock = 7, Description = "Manuel de développement agile pour créer un code propre." },
                    new Book { Id = 7, Title = "Dune", AuthorId = 7, Category = BookCategory.Fantasy, Price = 19.99m, PublicationDate = new DateTime(1965, 8, 1), IsAvailable = true, Stock = 9, Description = "Un chef-d'œuvre de science-fiction épique." },
                    new Book { Id = 8, Title = "Les Misérables", AuthorId = 8, Category = BookCategory.Fiction, Price = 29.99m, PublicationDate = new DateTime(1862, 3, 30), IsAvailable = true, Stock = 6, Description = "Le roman social de Victor Hugo." },
                });
            }
        }
    }
